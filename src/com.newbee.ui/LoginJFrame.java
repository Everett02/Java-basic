...
import com.newbee.ui.user.User;
...
public class LoginJFrame extends JFrame implements MouseListener {
    ...
    static {
        allUsers.add(new User("abc","123"));
        allUsers.add(new User("adc","1234"));
    }
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getSource() == login) {
            ...
            if (codeInput.length() == 0) {
                showJDialog("Verification code can not be empty");
            } else if (usernameInput.length() == 0 || passwordInput.length() == 0) {
                System.out.println("Username or password are empty");
                showJDialog("Username or password are empty");


            } else if (!codeInput.equalsIgnoreCase(rightCode.getText())) {
                showJDialog("Verification is wrong");
                ...
                showJDialog("Username and password are not matched");
            }
        } else if (e.getSource() == register) {
            System.out.println("Press the register button");
